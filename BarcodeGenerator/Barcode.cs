...
namespace BarcodeGenerator
{
    public class Barcode
    {
        ...
        private readonly string path = @"D:\Downloads\BarcodeGenerator-master\EanBarcodeGenerator\BarcodeGenerator\Barcodes";
        ...
        public Image DrawBarcode()
        {
            ...
            var ibarcode = new EAN13(Data, Width, Height, _Scale);
            Data = ibarcode.Data;
