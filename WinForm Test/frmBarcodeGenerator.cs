    ...
    public partial class frmBarcodeGenerator : Form
    {
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show($"EAN13 Barcode saved: {txtBarcode.Text}", "EAN13", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, "BarcodeGenerator", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void encodeTitle_Click(object sender, EventArgs e)
        {
